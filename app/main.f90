!> \file    main.f90
!> \copydoc sm_drought_index

!>  \brief SOIL MOISTURE DROUGHT INDEX
!>  \details Estimate the soil moisture index using daily values generated by mHM
!!           ALGORITHM:
...
!!
!> \authors  Luis E. Samaniego-Eguiguren, Matthias Zink, Stephan Thober
!> \date     15.02.2011
!!           - (LS) main structure
!> \date     20.02.2011
!!           - (LS) debuging
...
!!           - (LS) v4. read COSMO SM
!> \date     22.06.2012
!!           - (LS) v4. read WRF-NOAH SM
!> \date     07.11.2016
!!           - (MZ) modularized version
!> \date     20.03.2017
!!           - (LS) daily SMI, SAD flag, restructuring SAD
!> \date     24.07.2018
