...
#$ -o /data/stohyd/mHM_project/germany/pan_german/default_eve2_2/smi_2/$JOB_NAME.$JOB_ID # Log file
#$ -j y                    # Write error in log file
#$ -l h_rt=24:00:00         # Request resource: hard run time hours:minutes:seconds
