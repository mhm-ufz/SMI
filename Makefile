...
CONFIGPATH := /home/zink/lib/makefile_chs/make.config      # where are the $(system).$(compiler) files
MAKEDPATH  := /home/zink/lib/makefile_chs/make.config      # where is the make.d.sh script
