...
{\Huge \textbf{FORP}}\\
\vspace*{0.5cm}
{\Large \textbf{The Soil Moisture Index - SMI program}}\\
\vspace*{1cm}
\includegraphics[width=6.0cm]{../doc/figures/logo.png}\\
\vspace*{1.5cm}
...
\vspace*{0.5cm}
{\large \input{../doc/contributor.txt}}\\
\vfill{}
{\huge \textbf{The CHS department}}\\
\textcolor{blue}{https://git.ufz.de/chs}\\
\vspace*{0.5cm}
